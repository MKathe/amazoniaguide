...
public class PaymentePendientFragment extends BaseFragment implements PaymentContract.View {
    ...
    public PaymentePendientFragment() {
    ...
    public static PaymentePendientFragment newInstance() {
        return new PaymentePendientFragment();
    }
